...
6. All of your checkbox elements should be set to appearance: none; in your CSS.
7. All of your checkbox elements should have a border width, color and style of your choosing.
8. When the checkbox is checked, it should display a checkmark ✓ in the center of the checkbox.
9. When the checkbox is checked, the background color of the checkbox should change to a color of your choosing.
10. When the checkbox is checked, the border color of the checkbox should change to a color of your choosing.
